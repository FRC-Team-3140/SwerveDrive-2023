...
import frc.robot.commands.Arm.ArmRunTrial;
...
public class RobotContainer {
  ...
  private static DigitalInput limitSwitchUpper = new DigitalInput(2);
  private static DigitalInput limitSwitchLower = new DigitalInput(3);
  ...
  private void configureButtonBindings() {
    ...
    BooleanSupplier clawButtonPressedSupplier = () -> m_xbox_cotroller_2.getBButton();
 ...
 //   m_xbox_cotroller.x(new EventLoop()).;
    ...
    //   .onTrue(new OneCubeAuto(swerveDrive, claw, arm));
    new JoystickButton(m_xbox_cotroller_2, Button.kLeftBumper.value)
    .onTrue(new DriveToWall(swerveDrive));
    ...
    final JoystickButton rightBumper = new JoystickButton(m_xbox_cotroller, Button.kRightBumper.value);
     ...
     rightBumper.whileTrue(new balance(swerveDrive));
      ...
      new JoystickButton(m_xbox_cotroller_2, Button.kX.value).onTrue(new InstantCommand(() -> led.toggleLED()));
