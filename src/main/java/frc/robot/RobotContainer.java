...
public class RobotContainer {
  ...
  private RobotContainer() {
    ...
    m_chooser.addOption("Arm Top Auto", new ArmTopAuto(arm));
    m_chooser.addOption("One Cube Auto ", new OneCubeAuto(swerveDrive, claw, arm));
    m_chooser.addOption("Everything", new EverythingAuto(swerveDrive, arm, claw));
 ...
 //   m_xbox_cotroller.x(new EventLoop()).;
    ...
    final JoystickButton rightBumper = new JoystickButton(m_xbox_cotroller, Button.kRightBumper.value);
     ...
     new JoystickButton(m_xbox_cotroller_2, Button.kLeftBumper.value).onTrue(new ArmPosition(arm, 70));
