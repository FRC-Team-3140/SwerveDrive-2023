...
import frc.robot.commands.Auto2.Balance.BalanceAndEngage;
import frc.robot.commands.Auto2.Balance.BalanceTogether;
import frc.robot.commands.Auto2.Balance.ClimbRamp;
import frc.robot.commands.Auto2.Balance.MoveToRamp;
...
//     double pitch_change = Math.abs(50.0 * (filtered_roll - m_last_roll)); // Estimate the pitch change per second
