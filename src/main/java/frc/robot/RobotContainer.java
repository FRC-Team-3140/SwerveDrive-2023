...
public class RobotContainer {
  ...
  private RobotContainer() {
    ...
    m_chooser.addOption("One Cne ne Cube", new OneConeOneCubeAuto(swerveDrive, arm, wrist, claw));
  ...
  private void configureButtonBindings() {
    ...
    new JoystickButton(m_xbox_cotroller_2, Button.kStart.value).whileTrue(new RunCommand(()-> led.rainbow()));
