...
public class Wrist extends SubsystemBase {
  ...
  public Wrist(int WristID) {
    ...
    // NetworkTableInstance.getDefault().getTable("Arm").getEntry("Wrist
    // P").setDouble(0.027074);
    // .03
    // NetworkTableInstance.getDefault().getTable("Arm").getEntry("Wrist
    // D").setDouble(0.015);
    // .02
  ...
  private void registerSettings() {
    ...
    comms.registerDoubleSetting("Wrist", "Set Point", wristPidController::getSetpoint, wristPidController::setSetpoint,
        0.0);
  }
  ...
  public void periodic() {
    ...
    // NetworkTableInstance.getDefault().getTable("Arm").getEntry("Wrist PID
    // Output").setDouble(wristPidController.calculate(WristAngle));
    // NetworkTableInstance.getDefault().getTable("Arm").getEntry("Wrist
    // Voltage").setDouble(motorVoltage);
    // wristP = NetworkTableInstance.getDefault().getTable("Arm").getEntry("Wrist
    // P").getDouble(0.0);
    // wristD = NetworkTableInstance.getDefault().getTable("Arm").getEntry("Wrist
    // D").getDouble(0.0);

    // if (wristP != wristPidController.getP() || wristD !=
    // wristPidController.getD()) {
