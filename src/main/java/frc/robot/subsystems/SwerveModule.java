...
public class SwerveModule{
    ...
    public void periodic() {
        ...
        double P = NetworkTableInstance.getDefault().getTable("PID").getEntry("P").getDouble(0.0);
        double I = NetworkTableInstance.getDefault().getTable("PID").getEntry("I").getDouble(0.0);
    ...
    public void setStates(SwerveModuleState state, boolean locked, double angle){
        state = SwerveModuleState.optimize(state, new Rotation2d(cANCoder.getPosition() / 180 * Math.PI));

        setAngle(state.angle.getDegrees(), locked);//clipAngle(state.angle.getDegrees()), locked);
